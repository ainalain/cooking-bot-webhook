module.exports = {
  "aunt-beef": {
    ...
    "category": "Meat",
    "serving": "6 ",
    "ingredients": ["1 kg beef stew: stewing steak or chuck roast, 2 large onions, 50 grams butter, salt, pepper"],
    ...
    "summary": "You need to cut the onions and meat, brown them on the pan with butter, then put all the ingredients into the saucepan and leave them boiling lightly for an hour and a half."
  },
  "braised-rabbit": {
    "id": "braised-rabbit",
    ...
    "summary": "First of all you need to brown the rabbit meat on the roasting pan, then put all the ingredients in the saucepan and braise them with water about 1 hour."
  },
  "baked-ham": {
    "id": "baked-ham",
    "title": "Baked ham",
    ...
    "category": "Meat",
    "serving": "6-12",
    "ingredients": ["600-1200 grams of ham, 8-10 garlic cloves, 1 carrot stick, salt, pepper, optional: dried or fresh herbs for pork"],
    ...
    "summary": "After turning on the oven to preheat it, fill the ham with garlic and carrots, wrap it with foil and put in the oven for an hour and half."
  }
};
